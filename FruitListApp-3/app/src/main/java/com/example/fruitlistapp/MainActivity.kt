...
class MainActivity : AppCompatActivity() {
    ...
    // Reusing the FruitAdapter from class for Rental Listings
    lateinit var adapter: FruitAdapter

    // Reusing class Fruit for the list of Rentals
    ...
    fun rowClicked(position:Int){
        ...
        val snackbar = Snackbar.make(binding.rootLayout, "Like it? Shortlist it!", Snackbar.LENGTH_LONG)
        snackbar.show()
    }

    // rv: Favorite button click handler
    fun favButtonClicked(position:Int) {
        val snackbar = Snackbar.make(binding.rootLayout, "Added to Shortlist", Snackbar.LENGTH_LONG)
        snackbar.show()
    }
